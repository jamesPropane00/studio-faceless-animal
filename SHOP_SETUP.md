...
## 10. Fanvue external listings

Choose **Fanvue post / profile link** in the admin and paste the public Fanvue profile, tracking, or post URL. Enter a clear title, a general-audience description, the advertised price, and upload only a non-explicit promotional image. The confirmation box is required before the secure admin function accepts the listing.
