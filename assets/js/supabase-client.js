...
const FALLBACK_SUPABASE_ANON_KEY = 'sb_publishable_kixI74nB7Drt6mQKooaXHg_nPoE0h_-'

const SUPABASE_URL      = cfg.supabaseUrl     || FALLBACK_SUPABASE_URL
const SUPABASE_ANON_KEY = cfg.supabaseAnonKey || FALLBACK_SUPABASE_ANON_KEY
